...
public class UsuariosRedesSociales extends Controller {
    ...
    private static UsuarioRedSocial getUser() {
        return UsuarioRedSocial.findOrCreate("guest");
    }
